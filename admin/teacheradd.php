...
if(isset ($_POST['tname'])){
	...
	$query =$conn->prepare("INSERT INTO `teacherinfo` (`name`,`username`,`password`,`img`,`sub1`,`sub2`,`sub3`,`sub4`,`sub5`) VALUES (?,?,?,?,?,?,?,?,?)");
	$query->bind_param("ssssiiiii", $tname,$username,$encpass,$img,$sub1,$sub2,$sub3,$sub4,$sub5);
	$query->execute();
