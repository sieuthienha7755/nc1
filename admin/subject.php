...
<?php
	...
	echo "<td>";
	//single delete form
	echo "<form action='../admin/subjectdel.php' method='post'  style='width=50%;'>";
...
<form action="../admin/subjectadd.php" method="post" style="width=50%;">
<td>
...
<!--EditModal-->
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        <form action="../admin/subjectedit.php" method="post">
