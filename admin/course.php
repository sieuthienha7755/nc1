...
<?php
	...
	$query->execute();
	$r = $query->get_result();
	echo('<table id="mytable" class="table table-hover"><thead id="tablehead"><tr ><th>Select</th><th id="courseid">ID &#x21D5;</th><th id="coursename">Name &#x21D5;</th><th>Delete</th></tr></thead><tbody>');
	...
	echo "<td>";
	//single delete form
	echo "<form action='../admin/coursedel.php' method='post'  style='width=50%;'>";
...
<form action="../admin/courseadd.php" method="post" style="width=50%;">
<td>
